...
import { LoginForm, SignupForm, ForgotForm } from "./forms";
              ...
              <ModalBody>
                <Tabs
                  ...
                  onSelectionChange={(key) =>
                    setActiveTab(key as "login" | "signup" | "forgot")
                  }
                >
                ...
                <div className="flex items-center gap-4 py-2">
                  ...
                  <p className="text-tiny text-default-400 shrink-0">
                    或者使用（第三方登录暂未开放）
                  </p>
                  <Divider className="flex-1" />
                </div>
